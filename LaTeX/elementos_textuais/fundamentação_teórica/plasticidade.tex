...
definida como uma combinação de diversos fatores: a probabilidade de liberação de neurotransmissor pré-sináptica, de quão
relevante é a resposta pós-sináptica à liberação de uma única vesícula de neurotransmissor e ao número de locais de liberação de
neurotransmissor~\cite{fattSpontaneous1952}. 
...
ativaçãom, tensão, entre outros, dependendo do neurônio específico, da sinapse e dos mecanismos moleculares e celulares
envolvidos.
