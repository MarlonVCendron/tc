...
\input{elementos_textuais/introdução/objetivo_geral}

\input{elementos_textuais/introdução/objetivos_específicos}

\input{elementos_textuais/introdução/estrutura_do_trabalho}