...
#ifndef SLEEPYSTIMULUSGROUP_H_

#define SLEEPYSTIMULUSGROUP_H_
...
class SleepyStimulusGroup : public SpikingGroup {
private:
  AurynTime *clk;
...
protected:
  ...
  /* next time the it will sleep or awake  */
...
public:
  ...
  /* Duration of sleep */
  AurynFloat sleep_duration;

  /* Duration of awake activity */
  AurynFloat awake_duration;
   ...
   * */
  SleepyStimulusGroup(NeuronID n, string filename, string stimfile, StimulusGroupModeType stimulusmode = RANDOM, AurynFloat baserate = 1.0);
   ...
   * \param baserate The base firing rate with which all activity is multiplied.
   * */
  SleepyStimulusGroup(NeuronID n, string stimfile, StimulusGroupModeType stimulusmode = RANDOM, AurynFloat baserate = 1.0);

  virtual ~SleepyStimulusGroup();
  ...
  /*! \brief Sets the stimulation mode. Can be any of SleepyStimulusGroupModeType (MANUAL,RANDOM,SEQUENTIAL,SEQUENTIAL_REV). */
